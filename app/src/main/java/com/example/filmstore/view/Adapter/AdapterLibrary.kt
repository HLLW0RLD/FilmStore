...
class AdapterLibrary : RecyclerView.Adapter<AdapterLibrary.MainViewHolder>(), SetOnItemViewClickListener{

    private var filmData: List<Film> = RepositoryImpl().getMyFilms()
